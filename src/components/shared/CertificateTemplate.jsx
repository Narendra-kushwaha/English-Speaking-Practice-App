...
export const CERTIFICATE_STYLES = `
  ...
  * {
  ...
  .certificate {
    ...
    box-shadow:
      inset 0 0 0 0.65mm #f0d998,
      inset 0 0 18mm rgba(199, 143, 22, 0.09);
  }
  ...
  .certificate::after {
    ...
    position: absolute;
    inset: 5.4mm;
    border: 0.18mm solid rgba(199, 143, 22, 0.68);
    pointer-events: none;
  }
  ...
  .certificate-corner-tl {
    top: 5mm;
    left: 5mm;
    border-top: 0.9mm solid;
    border-left: 0.9mm solid;
  }
  ...
  .certificate-corner-tr {
    ...
    right: 5mm;
    border-top: 0.9mm solid;
    border-right: 0.9mm solid;
  }

  .certificate-corner-bl {
    bottom: 5mm;
    left: 5mm;
    border-bottom: 0.9mm solid;
    border-left: 0.9mm solid;
  }
  ...
  .certificate-stat {
    ...
    align-items: center;
    gap: 2mm;
    border-right: 0.32mm solid #d39a1b;

    background: linear-gradient(
      180deg,
      rgba(255, 255, 255, 0.5),
      rgba(255, 248, 222, 0.32)
    );
  }

  .certificate-stat:last-child {
    border-right: 0;
  }
  ...
  .certificate-qr {
    ...
    padding: 0.7mm;
    background: #fffdf5;
    border: 0.25mm solid rgba(199, 143, 22, 0.55);
    box-shadow: 0 1mm 3mm rgba(16, 43, 82, 0.08);
  }
    ...
    <div class="certificate-page">
      <div class="certificate">
        ...
        <div class="certificate-inner">
          <div class="certificate-brand">
            <div class="certificate-brand-row">
              ...
              <div class="certificate-institute">
                ${escapeCertificateHtml(instituteName)}
              </div>
            </div>

            <div class="certificate-academy">
              ${escapeCertificateHtml(academyTitle)}
            </div>
          </div>

          <div class="certificate-divider">
            <div
              class="certificate-divider-line"
            ></div>

            <span
              class="certificate-divider-star"
            >
              *
            </span>
          ...
          <div class="certificate-certify">
            This is to certify that
          </div>

          <div class="certificate-student">
            ${escapeCertificateHtml(studentName)}
          </div>
          ...
          <div class="certificate-course">
            ...
            <strong>
              ${escapeCertificateHtml(courseName)}
            </strong>

            <br />

            with dedication and outstanding
            performance.
          </div>
          ...
          <div class="certificate-dates">
            ...
            ${formatCertificateDate(endDate)}
          </div>

          <div class="certificate-stats">
            <div class="certificate-stat">
              <div
                class="certificate-stat-icon"
              >
                S
              </div>

              <div
                class="certificate-stat-main"
              >
                <div
                  class="certificate-stat-value"
                >
                  ${totalScore}
                </div>

                <div
                  class="certificate-stat-label"
                >
                  TOTAL SCORE
                </div>
              </div>
          ...
          <div class="certificate-bottom">
            ...
            <span>
              Certificate ID:
              ${escapeCertificateHtml(certificateId)}
            </span>
          </div>
        </div>
      </div>
...
export function buildCertificateDocument(data = {}) {
  return `
    <!DOCTYPE html>
    <html lang="en">
      <head>
